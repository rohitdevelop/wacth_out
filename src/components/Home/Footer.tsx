            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  />
                  <button className="absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer bg-gradient-to-r from-gray-100 to-gray-100 px-4 text-black py-1.5  text-sm font-medium hover:shadow-lg hover:shadow-green-500/50 transition-all">
                    Join
                  </button>
                </div>
