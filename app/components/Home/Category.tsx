    ...
    <section className="bg-gradient-to-b from-black via-green-950 to-black py-10 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-light mt-3 sm:mt-4">
        ...
        <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center mb-8 sm:mb-12">
          ...
          >
            <div className="relative w-[280px] sm:w-[340px] md:w-[380px] lg:w-[420px] h-[380px] sm:h-[440px] md:h-[480px] lg:h-[550px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.8)] group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 lg:p-8">
                <div className="mb-2 sm:mb-3">
                  <span className="text-amber-400 text-[10px] sm:text-xs font-semibold tracking-wider sm:tracking-widest uppercase">
                    Collection {current + 1} of {categories.length}
                  </span>
                </div>
              ...
              {/* Number Badge */}
              <div className="absolute top-4 sm:top-5 lg:top-6 right-4 sm:right-5 lg:right-6 bg-white/10 backdrop-blur-md rounded-full w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 flex items-center justify-center border border-white/20">
                <span className="text-lg sm:text-xl font-bold">{current + 1}</span>
              </div>
            </div>
          </div>
        ...
        <div className="md:hidden text-center mt-8 text-sm text-white/40">
